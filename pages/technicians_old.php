...
// ========== NOUVEAU : GESTION DES ÉQUIPES ==========

// Création d'une équipe
if($action == 'team_add' && $_SERVER['REQUEST_METHOD'] == 'POST') {
    $stmt = $pdo->prepare("INSERT INTO teams (name, description, leader_id) VALUES (?, ?, ?)");
    $result = $stmt->execute([
        $_POST['team_name'],
        $_POST['description'],
        !empty($_POST['leader_id']) ? $_POST['leader_id'] : null
    ]);
    ...
    if($result) {
        ...
        if(!empty($_POST['leader_id'])) {
            ...
            $stmt2->execute([$team_id, $_POST['leader_id']]);
        }
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="?page=technicians&action=add" class="btn btn-primary me-2">
                <i class="fas fa-plus"></i> <?php echo t('add_technician'); ?>
            </a>
            <a href="?page=technicians&action=team_add" class="btn btn-success">
    ...
    <div class="info-card mt-5">
        <div class="card-header-custom d-flex justify-content-between align-items-center">
            ...
            <a href="?page=technicians&action=team_add" class="btn btn-success btn-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" class="btn btn-sm btn-info" title="Voir"><i class="fas fa-eye"></i></a>
                                <a href="#" class="btn btn-sm btn-warning" title="Modifier"><i class="fas fa-edit"></i></a>
                                <a href="?page=technicians&action=team_delete&team_id=<?php echo $team['id']; ?>" 
                        ...
                        <?php if(empty($teams)): ?>
                        <tr>
                            <td colspan="5" class="text-center py-4 text-muted">Aucune équipe créée pour le moment.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>

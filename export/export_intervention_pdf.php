...
<body>
    ...
    <div class="section">
        ...
        <table class="info-table">
            ...
            <tr><td><strong>Creation Date</strong></td><td><?php echo format_date_local($intervention['created_at'], 'long', true); ?></td></tr>
    ...
    <div class="section">
        ...
        <table class="info-table">
            ...
            <tr><td><strong>Planned Date</strong></td><td><?php echo $intervention['intervention_date'] ? format_date_local($intervention['intervention_date'], 'long', false) : t('not_planned'); ?></td></tr>
            ...
            <tr><td><strong>Completion Date</strong></td><td><?php echo format_date_local($intervention['completed_date'], 'long', true); ?></td></tr>
            <?php endif; ?>
        </table>
    </div>
    ...
    <div class="footer">
        Document automatically generated by Industrial GMAO on <?php echo format_date_local(date('Y-m-d H:i:s'), 'long', true); ?>
    </div>
